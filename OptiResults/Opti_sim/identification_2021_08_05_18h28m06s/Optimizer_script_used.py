...
if log_real==True:
    log_path=os.path.join('/home/mehdi/Documents/identification_modele_avion/Logs/log_real/log_5_2021-7-20-11-12-20/log_real.csv')     
else:
...
name_script='Optimizer_script2.py'
if log_real==True:
    plot=False
